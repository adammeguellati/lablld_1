...
export default async function ResultadoPagoLink({ params, searchParams }: Props) {
  ...
  return (
    <div className="max-w-md mx-auto mt-20 text-center space-y-4 px-4">
      ...
      <p className="text-sm text-gray-500">Estamos confirmando la transacción con Wompi.</p>
